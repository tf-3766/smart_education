...
| 方法 | 路径 | 接口说明 | 角色 | 请求 | 响应 |
| --- | --- | --- | --- | --- | --- |
| `POST` | `/api/v1/auth/login` | 登录系统并获取访问令牌 | 匿名 | `LoginRequest` | `LoginVO` |
| `POST` | `/api/v1/auth/register` | 注册学生账号或提交教师注册申请 | 匿名 | `RegisterRequest` | `RegistrationVO`；学生 201，教师待审核 202 |
| `GET` | `/api/v1/auth/me` | 获取当前登录用户、角色和权限信息 | 已登录 | 无 | `CurrentUserVO` |
| `POST` | `/api/v1/auth/logout` | 退出当前登录会话 | 已登录 | 无 | `LogoutVO` |
| `PUT` | `/api/v1/auth/me/avatar` | 设置或移除当前用户头像 | 已登录 | `UpdateAvatarRequest` | `CurrentUserVO` |
...
| 方法 | 路径 | 接口说明 | 角色 | 请求 | 响应 |
| --- | --- | --- | --- | --- | --- |
| `POST` | `/api/v1/files` | 上传文件并登记文件元数据 | 已登录 | `multipart/form-data`：`file*`、`purpose?` | `StoredFileVO`，201 |
| `GET` | `/api/v1/files/{fileId}` | 查询指定文件的元数据信息 | 文件所有者、管理员或有业务资源访问权的用户 | 无 | `StoredFileVO` |
| `GET` | `/api/v1/files/{fileId}/content` | 下载或在线读取指定文件内容 | 同上 | 无 | 文件流，不使用 `ApiResponse` 包裹 |
| `DELETE` | `/api/v1/files/{fileId}` | 删除未被业务数据引用的文件 | 文件所有者或管理员 | 无 | `void`；被业务数据引用时返回 409 |
...
| 方法 | 路径 | 接口说明 | 请求 | 响应 |
| --- | --- | --- | --- | --- |
| `POST` | `/api/v1/teacher/courses` | 创建一门由当前教师负责的课程 | `CreateCourseRequest` | `CourseDetailVO`，201 |
| `GET` | `/api/v1/teacher/courses` | 分页查询当前教师参与的课程 | `CourseListQuery` | `PageResponse<TeacherCourseListItemVO>` |
| `GET` | `/api/v1/teacher/courses/{courseId}` | 查看教师负责课程的详细信息 | 路径参数 | `CourseDetailVO` |
| `PUT` | `/api/v1/teacher/courses/{courseId}` | 修改教师负责课程的基本资料 | `UpdateCourseRequest` | `CourseDetailVO` |
| `POST` | `/api/v1/teacher/courses/{courseId}/submit-review` | 提交课程发布审核申请 | 无 | `CourseDetailVO` |
| `POST` | `/api/v1/teacher/courses/{courseId}/publish` | 发布审核通过的课程 | 无 | `CourseDetailVO` |
| `POST` | `/api/v1/teacher/courses/{courseId}/start` | 将已发布课程变更为进行中 | 无 | `CourseDetailVO` |
| `POST` | `/api/v1/teacher/courses/{courseId}/finish` | 将进行中课程变更为已结束 | 无 | `CourseDetailVO` |
| `POST` | `/api/v1/teacher/courses/{courseId}/offline` | 下线当前教师负责的课程 | 无 | `CourseDetailVO` |
| `GET` | `/api/v1/teacher/courses/{courseId}/teachers` | 查询课程教师团队成员 | 无 | `List<CourseTeacherVO>` |
| `POST` | `/api/v1/teacher/courses/{courseId}/teachers` | 向课程教师团队添加成员 | `AddCourseTeacherRequest` | `CourseTeacherVO` |
| `DELETE` | `/api/v1/teacher/courses/{courseId}/teachers/{teacherId}` | 从课程教师团队移除成员 | 路径参数 | `void` |

### 3.4 教师课程内容管理

| 方法 | 路径 | 接口说明 | 请求 | 响应 |
| --- | --- | --- | --- | --- |
| `GET` | `/api/v1/teacher/courses/{courseId}/chapters` | 查询课程的全部章节 | 无 | `List<ChapterDetailVO>` |
| `POST` | `/api/v1/teacher/courses/{courseId}/chapters` | 为课程创建新章节 | `CreateChapterRequest` | `ChapterDetailVO`，201 |
| `PUT` | `/api/v1/teacher/chapters/{chapterId}` | 修改指定章节的信息 | `UpdateChapterRequest` | `ChapterDetailVO` |
| `DELETE` | `/api/v1/teacher/chapters/{chapterId}` | 删除未受业务限制的章节 | 路径参数 | `void` |
| `POST` | `/api/v1/teacher/chapters/{chapterId}/publish` | 发布指定课程章节 | 无 | `ChapterDetailVO` |
| `POST` | `/api/v1/teacher/chapters/{chapterId}/offline` | 下线指定课程章节 | 无 | `ChapterDetailVO` |
| `GET` | `/api/v1/teacher/chapters/{chapterId}/lessons` | 查询指定章节的课时列表 | 无 | `List<LessonDetailVO>` |
| `POST` | `/api/v1/teacher/chapters/{chapterId}/lessons` | 在指定章节中创建课时 | `CreateLessonRequest` | `LessonDetailVO`，201 |
| `GET` | `/api/v1/teacher/lessons/{lessonId}` | 查看指定课时的详细内容 | 路径参数 | `LessonDetailVO` |
| `PUT` | `/api/v1/teacher/lessons/{lessonId}` | 修改指定课时的内容与设置 | `UpdateLessonRequest` | `LessonDetailVO` |
| `DELETE` | `/api/v1/teacher/lessons/{lessonId}` | 删除未受业务限制的课时 | 路径参数 | `void` |
| `POST` | `/api/v1/teacher/lessons/{lessonId}/publish` | 发布指定课程课时 | 无 | `LessonDetailVO` |
| `POST` | `/api/v1/teacher/lessons/{lessonId}/offline` | 下线指定课程课时 | 无 | `LessonDetailVO` |
| `GET` | `/api/v1/teacher/courses/{courseId}/materials` | 分页查询课程资料 | `CourseMaterialListQuery` | `PageResponse<CourseMaterialVO>` |
| `POST` | `/api/v1/teacher/courses/{courseId}/materials` | 为课程新增学习资料 | `CreateCourseMaterialRequest` | `CourseMaterialVO`，201 |
| `PUT` | `/api/v1/teacher/materials/{materialId}` | 修改指定课程资料 | `UpdateCourseMaterialRequest` | `CourseMaterialVO` |
| `DELETE` | `/api/v1/teacher/materials/{materialId}` | 删除指定课程资料 | 路径参数 | `void` |

### 3.5 学生课程与学习

| 方法 | 路径 | 接口说明 | 请求 | 响应 |
| --- | --- | --- | --- | --- |
| `GET` | `/api/v1/student/courses/catalog` | 查询当前可浏览和可选的课程目录 | `CourseListQuery` | `PageResponse<StudentCourseListItemVO>` |
| `GET` | `/api/v1/student/courses` | 查询当前学生已选课程 | `CourseListQuery` | `PageResponse<StudentCourseListItemVO>` |
| `GET` | `/api/v1/student/courses/{courseId}` | 查看学生可访问的课程详情 | 路径参数 | `CourseDetailVO` |
| `POST` | `/api/v1/student/courses/{courseId}/enroll` | 选修指定课程 | 无 | `EnrollmentVO` |
| `POST` | `/api/v1/student/courses/{courseId}/withdraw` | 退出已选的指定课程 | 无 | `EnrollmentVO` |
| `GET` | `/api/v1/student/courses/{courseId}/outline` | 获取已选课程的学习大纲 | 路径参数 | `CourseOutlineVO` |
| `GET` | `/api/v1/student/lessons/{lessonId}` | 查看学生有权访问的课时内容 | 路径参数 | `StudentLessonDetailVO` |
| `POST` | `/api/v1/student/lessons/{lessonId}/start` | 记录学生开始学习指定课时 | 无 | `LearningRecordVO` |
| `POST` | `/api/v1/student/lessons/{lessonId}/complete` | 标记指定课时为已完成 | 无 | `LearningRecordVO` |
| `GET` | `/api/v1/student/courses/{courseId}/progress` | 查看当前学生的课程学习进度 | 路径参数 | `CourseProgressVO` |
| `GET` | `/api/v1/student/materials/{materialId}` | 获取学生有权访问的课程资料 | 路径参数 | `MaterialAccessVO` |

### 3.6 管理员课程审核与治理

| 方法 | 路径 | 接口说明 | 请求 | 响应 |
| --- | --- | --- | --- | --- |
| `GET` | `/api/v1/admin/course-reviews` | 分页查询课程审核任务 | `CourseListQuery` | `PageResponse<CourseReviewListItemVO>` |
| `GET` | `/api/v1/admin/course-reviews/{courseId}` | 查看指定课程的审核详情 | 路径参数 | `CourseReviewDetailVO` |
| `POST` | `/api/v1/admin/course-reviews/{courseId}/approve` | 批准课程发布审核申请 | `ReviewCourseRequest` | `CourseReviewVO` |
| `POST` | `/api/v1/admin/course-reviews/{courseId}/reject` | 驳回课程发布审核申请 | `RejectCourseRequest` | `CourseReviewVO` |
| `GET` | `/api/v1/admin/courses/{courseId}` | 查看管理员可治理的课程详情 | 路径参数 | `CourseDetailVO` |
| `PUT` | `/api/v1/admin/courses/{courseId}` | 修改课程元数据和时间安排 | `UpdateCourseRequest` | `CourseDetailVO` |
| `POST` | `/api/v1/admin/courses/{courseId}/offline` | 由管理员下线指定课程 | 无 | `CourseDetailVO` |
...
| 方法 | 路径 | 接口说明 | 角色 | 请求 | 响应 |
| --- | --- | --- | --- | --- | --- |
| `GET` | `/api/v1/admin/users` | 分页查询系统用户及其审核状态 | 超级管理员 | `AdminUserQuery` | `PageResponse<AdminUserVO>` |
| `PUT` | `/api/v1/admin/users/{userId}/administrator` | 授予指定用户普通管理员身份 | 超级管理员 | 无 | `AdminUserVO` |
| `DELETE` | `/api/v1/admin/users/{userId}/administrator` | 撤销指定用户普通管理员身份 | 超级管理员 | 无 | `AdminUserVO` |
| `PUT` | `/api/v1/admin/users/{userId}/teacher-approval` | 批准指定用户的教师注册申请 | 超级管理员 | 无 | `AdminUserVO`，通过教师申请 |
| `DELETE` | `/api/v1/admin/users/{userId}/teacher-approval` | 拒绝指定用户的教师注册申请 | 超级管理员 | 无 | `AdminUserVO`，拒绝教师申请 |
...
| 方法 | 路径 | 接口说明 | 角色 | 请求体或查询 | 成功响应 `data` | 状态 |
| --- | --- | --- | --- | --- | --- | --- |
| `GET` | `/api/v1/teacher/courses/{courseId}/assignments` | 分页查询课程作业 | 教师 | `page/size/keyword/status/sort` | `PageResponse<AssignmentDetailVO>` | 已实现 |
| `POST` | `/api/v1/teacher/courses/{courseId}/assignments` | 为课程创建作业 | 教师 | `AssignmentCreateRequest` | `AssignmentDetailVO`，HTTP 201 | 已实现 |
| `PUT` | `/api/v1/teacher/assignments/{assignmentId}` | 修改指定作业 | 教师 | `AssignmentUpdateRequest` | `AssignmentDetailVO` | 已实现 |
| `POST` | `/api/v1/teacher/assignments/{assignmentId}/publish` | 发布指定作业 | 教师 | 无 | `AssignmentDetailVO` | 已实现 |
| `POST` | `/api/v1/teacher/assignments/{assignmentId}/close` | 关闭指定作业的提交入口 | 教师 | 无 | `AssignmentDetailVO` | 已实现 |
| `GET` | `/api/v1/student/courses/{courseId}/assignments` | 查询学生在课程中的作业列表 | 学生 | `page/size/keyword/status/sort` | `PageResponse<StudentAssignmentListItemVO>` | 已实现 |
| `GET` | `/api/v1/student/assignments/{assignmentId}` | 查看学生作业详情和本人提交 | 学生 | 无 | `StudentAssignmentDetailVO` | 已实现 |
| `PUT` | `/api/v1/student/assignments/{assignmentId}/submission-draft` | 保存或更新作业提交草稿 | 学生 | `SubmissionSaveRequest` | `SubmissionDetailVO` | 已实现 |
| `POST` | `/api/v1/student/assignments/{assignmentId}/submissions` | 正式提交指定作业 | 学生 | `SubmissionSubmitRequest` | `SubmissionDetailVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/assignments/{assignmentId}/submissions` | 分页查询指定作业的学生提交 | 教师 | `page/size/submissionStatus` | `PageResponse<TeacherSubmissionGradeVO>` | 已实现 |
| `POST` | `/api/v1/teacher/submissions/{submissionId}/grade` | 批改学生作业并保存成绩草稿 | 教师 | `GradeSubmissionRequest` | `TeacherSubmissionGradeVO` | 已实现 |
| `POST` | `/api/v1/teacher/grades/{gradeId}/publication` | 发布指定学生成绩 | 教师 | `PublishGradeRequest` | `TeacherSubmissionGradeVO` | 已实现 |
| `GET` | `/api/v1/student/grades` | 分页查询当前学生已发布成绩 | 学生 | `GradeListQuery` | `PageResponse<StudentGradeVO>` | 已实现 |
| `GET` | `/api/v1/teacher/assignments/{assignmentId}/statistics` | 查看指定作业的提交与成绩统计 | 教师 | 无 | `AssignmentStatisticsVO` | 已实现 |
| `GET` | `/api/v1/teacher/courses/{courseId}/grade-statistics` | 查看课程维度的成绩统计 | 教师 | 无 | `CourseGradeStatisticsVO` | 已实现 |
...
| 方法 | 路径 | 接口说明 | 角色 | 请求体或查询 | 成功响应 `data` | 状态 |
| --- | --- | --- | --- | --- | --- | --- |
| `GET` | `/api/v1/student/courses/{courseId}/forum/topics` | 分页查询学生可见的课程论坛主题 | 学生 | `page/size/status/keyword` | `PageResponse<ForumTopicListItemVO>` | 已实现 |
| `POST` | `/api/v1/student/courses/{courseId}/forum/topics` | 由学生发布课程论坛主题 | 学生 | `ForumTopicCreateRequest` | `ForumTopicDetailVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/student/forum/topics/{topicId}` | 查看学生可见的论坛主题详情 | 学生 | 无 | `ForumTopicDetailVO` | 已实现 |
| `GET` | `/api/v1/student/forum/topics/{topicId}/replies` | 分页查询论坛主题回复 | 学生 | `page/size/status` | `PageResponse<ForumReplyVO>` | 已实现 |
| `POST` | `/api/v1/student/forum/topics/{topicId}/replies` | 由学生回复论坛主题 | 学生 | `ForumReplyCreateRequest` | `ForumReplyVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/courses/{courseId}/forum/topics` | 分页查询教师负责课程的论坛主题 | 教师 | `page/size/status/keyword` | `PageResponse<ForumTopicListItemVO>` | 已实现 |
| `POST` | `/api/v1/teacher/courses/{courseId}/forum/topics` | 由教师发布课程论坛主题 | 教师 | `ForumTopicCreateRequest` | `ForumTopicDetailVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/forum/topics/{topicId}` | 查看教师可管理的论坛主题详情 | 教师 | 无 | `ForumTopicDetailVO` | 已实现 |
| `GET` | `/api/v1/teacher/forum/topics/{topicId}/replies` | 分页查询教师可见的论坛回复 | 教师 | `ForumListQuery` | `PageResponse<ForumReplyVO>` | 已实现 |
| `POST` | `/api/v1/teacher/forum/topics/{topicId}/replies` | 由教师回复论坛主题 | 教师 | `ForumReplyCreateRequest` | `ForumReplyVO`，HTTP 201 | 已实现 |
| `PATCH` | `/api/v1/teacher/forum/topics/{topicId}/visibility` | 设置课程论坛主题的可见状态 | 教师 | `ForumVisibilityRequest` | `ForumTopicDetailVO` | 已实现 |
| `PATCH` | `/api/v1/teacher/forum/replies/{replyId}/visibility` | 设置课程论坛回复的可见状态 | 教师 | `ForumVisibilityRequest` | `ForumReplyVO` | 已实现 |
| `PATCH` | `/api/v1/admin/forum/topics/{topicId}/visibility` | 由管理员治理论坛主题可见状态 | 管理员 | `ForumVisibilityRequest` | `ForumTopicDetailVO` | 已实现 |
| `PATCH` | `/api/v1/admin/forum/replies/{replyId}/visibility` | 由管理员治理论坛回复可见状态 | 管理员 | `ForumVisibilityRequest` | `ForumReplyVO` | 已实现 |
| `POST` | `/api/v1/teacher/courses/{courseId}/warnings/generation` | 按规则生成或预览课程学习预警 | 教师 | `GenerateCourseWarningsRequest` | `WarningGenerationResultVO` | 已实现 |
| `GET` | `/api/v1/student/warnings` | 分页查询当前学生的学习预警 | 学生 | `WarningListQuery` | `PageResponse<LearningWarningVO>` | 已实现 |
| `GET` | `/api/v1/student/warnings/{warningId}` | 查看当前学生的预警详情 | 学生 | 无 | `LearningWarningVO` | 已实现 |
| `GET` | `/api/v1/teacher/courses/{courseId}/warnings` | 分页查询课程学习预警 | 教师 | `WarningListQuery` | `PageResponse<LearningWarningVO>` | 已实现 |
| `GET` | `/api/v1/teacher/warnings/{warningId}` | 查看教师可处理的预警详情 | 教师 | 无 | `LearningWarningVO` | 已实现 |
| `POST` | `/api/v1/teacher/warnings/{warningId}/handle` | 将指定预警标记为已处理或忽略 | 教师 | `WarningHandleRequest` | `LearningWarningVO` | 已实现 |
...
| 方法 | 路径 | 接口说明 | 角色 | 请求 / 成功响应 `data` | 状态 |
| --- | --- | --- | --- | --- | --- |
| `GET` | `/api/v1/teacher/courses/{courseId}/question-banks` | 分页查询课程题库 | 教师 | `QuestionBankListQuery` / `PageResponse<QuestionBankVO>` | 已实现 |
| `POST` | `/api/v1/teacher/courses/{courseId}/question-banks` | 为课程创建题库 | 教师 | `CreateQuestionBankRequest` / `QuestionBankVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/question-banks/{bankId}` | 查看指定题库详情 | 教师 | 无 / `QuestionBankVO` | 已实现 |
| `PUT` | `/api/v1/teacher/question-banks/{bankId}` | 修改指定题库 | 教师 | `UpdateQuestionBankRequest` / `QuestionBankVO` | 已实现 |
| `DELETE` | `/api/v1/teacher/question-banks/{bankId}` | 删除未被业务引用的题库 | 教师 | 无 / `void` | 已实现 |
| `GET` | `/api/v1/teacher/question-banks/{bankId}/questions` | 分页查询题库中的题目 | 教师 | `QuestionListQuery` / `PageResponse<QuestionVO>` | 已实现 |
| `POST` | `/api/v1/teacher/question-banks/{bankId}/questions` | 向题库新增题目 | 教师 | `CreateQuestionRequest` / `QuestionVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/questions/{questionId}` | 查看指定题目详情 | 教师 | 无 / `QuestionVO` | 已实现 |
| `PUT` | `/api/v1/teacher/questions/{questionId}` | 修改指定题目 | 教师 | `UpdateQuestionRequest` / `QuestionVO` | 已实现 |
| `DELETE` | `/api/v1/teacher/questions/{questionId}` | 删除未被试卷引用的题目 | 教师 | 无 / `void` | 已实现 |
| `GET` | `/api/v1/teacher/courses/{courseId}/exams` | 分页查询课程考试 | 教师 | `ExamListQuery` / `PageResponse<ExamVO>` | 已实现 |
| `POST` | `/api/v1/teacher/courses/{courseId}/exams` | 为课程创建考试 | 教师 | `CreateExamRequest` / `ExamVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/exams/{examId}` | 查看指定考试详情 | 教师 | 无 / `ExamVO` | 已实现 |
| `PUT` | `/api/v1/teacher/exams/{examId}` | 修改指定考试 | 教师 | `UpdateExamRequest` / `ExamVO` | 已实现 |
| `DELETE` | `/api/v1/teacher/exams/{examId}` | 删除允许删除的考试 | 教师 | 无 / `void` | 已实现 |
| `POST` | `/api/v1/teacher/exams/{examId}/papers` | 为指定考试创建试卷 | 教师 | `CreateExamPaperRequest` / `ExamPaperVO`，HTTP 201 | 已实现 |
| `GET` | `/api/v1/teacher/exam-papers/{paperId}` | 查看指定试卷详情 | 教师 | 无 / `ExamPaperVO` | 已实现 |
| `PUT` | `/api/v1/teacher/exam-papers/{paperId}` | 修改指定试卷的题目编排 | 教师 | `UpdateExamPaperRequest` / `ExamPaperVO` | 已实现 |
| `DELETE` | `/api/v1/teacher/exam-papers/{paperId}` | 删除未发布的指定试卷 | 教师 | 无 / `void` | 已实现 |
| `POST` | `/api/v1/teacher/exam-papers/{paperId}/publish` | 发布指定试卷 | 教师 | 无 / `ExamPaperVO` | 已实现 |
| `GET` | `/api/v1/student/courses/{courseId}/exams` | 分页查询学生可参加的课程考试 | 学生 | `page`、`size`、`keyword` / `PageResponse<StudentExamListItemVO>` | 已实现，仅返回已发布考试 |
| `POST` | `/api/v1/student/exams/{examId}/attempts` | 开始考试或返回本人未提交答题记录 | 学生 | 无 / `ExamAttemptVO` | 已实现，重试开始未提交考试时幂等 |
| `GET` | `/api/v1/student/exam-attempts/{attemptId}` | 查看本人考试答题详情 | 学生 | 无 / `ExamAttemptVO` | 已实现，仅本人可读 |
| `POST` | `/api/v1/student/exam-attempts/{attemptId}/submit` | 提交考试答案并触发自动判分 | 学生 | `SubmitExamAttemptRequest` / `ExamAttemptVO` | 已实现 |
| `GET` | `/api/v1/teacher/exams/{examId}/attempts` | 分页查询指定考试的学生答题记录 | 教师 | `ExamAttemptListQuery` / `PageResponse<ExamAttemptVO>` | 已实现 |
| `POST` | `/api/v1/teacher/exam-attempts/{attemptId}/grade` | 人工评阅考试中的主观题 | 教师 | `GradeExamAttemptRequest` / `ExamAttemptVO` | 已实现，用于简答题人工评分 |
| `GET` | `/api/v1/teacher/courses/{courseId}/announcements` | 分页查询指定课程公告 | 教师 | `AnnouncementListQuery` / `PageResponse<AnnouncementVO>` | 已实现 |
| `POST` | `/api/v1/teacher/courses/{courseId}/announcements` | 发布指定课程公告 | 教师 | `CreateAnnouncementRequest` / `AnnouncementVO`，HTTP 201 | 已实现 |
| `POST` | `/api/v1/teacher/announcements/{announcementId}/withdrawal` | 撤回指定课程公告 | 教师 | `WithdrawAnnouncementRequest` / `AnnouncementVO` | 已实现 |
| `GET` | `/api/v1/teacher/announcements` | 查询当前教师可见的课程和系统公告 | 教师 | `AnnouncementListQuery` / `PageResponse<AnnouncementVO>` | 已实现，按负责课程与 `ALL/TEACHER` 受众过滤 |
| `GET` | `/api/v1/student/announcements` | 查询当前学生可见的课程和系统公告 | 学生 | `AnnouncementListQuery` / `PageResponse<AnnouncementVO>` | 已实现，按选课与受众过滤 |
| `GET` | `/api/v1/admin/announcements` | 分页查询系统公告 | 管理员 | `AnnouncementListQuery` / `PageResponse<AnnouncementVO>` | 已实现 |
| `POST` | `/api/v1/admin/announcements` | 发布系统公告 | 管理员 | `CreateAnnouncementRequest` / `AnnouncementVO`，HTTP 201 | 已实现 |
| `POST` | `/api/v1/admin/announcements/{announcementId}/withdrawal` | 撤回指定系统公告 | 管理员 | `WithdrawAnnouncementRequest` / `AnnouncementVO` | 已实现 |
| `GET` | `/api/v1/course-categories` | 查询当前启用的课程分类 | 已登录 | 无 / `List<CourseCategoryVO>` | 已实现，仅启用分类 |
| `GET` | `/api/v1/admin/course-categories` | 查询全部课程分类 | 管理员 | 无 / `List<CourseCategoryVO>` | 已实现 |
| `POST` | `/api/v1/admin/course-categories` | 创建课程分类 | 管理员 | `CreateCourseCategoryRequest` / `CourseCategoryVO`，HTTP 201 | 已实现 |
| `PUT` | `/api/v1/admin/course-categories/{categoryId}` | 修改指定课程分类 | 管理员 | `UpdateCourseCategoryRequest` / `CourseCategoryVO` | 已实现 |
| `DELETE` | `/api/v1/admin/course-categories/{categoryId}` | 删除未被课程引用的分类 | 管理员 | 无 / `void` | 已实现 |
| `GET` | `/api/v1/admin/statistics` | 获取管理端教学运行统计数据 | 管理员 | 无 / `AdminStatisticsVO` | 已实现 |
...
| 方法 | 路径 | 接口说明 | 角色 | 请求 / 响应 | 状态 |
| --- | --- | --- | --- | --- | --- |
| `POST` | `/api/v1/ai/courses/{courseId}/qa/stream` | 基于授权课程内容进行流式智能答疑 | 学生/教师 | `CourseQaRequest` / `text/event-stream` | 已实现，使用授权课时正文 |
| `POST` | `/api/v1/ai/lessons/{lessonId}/summary-draft` | 生成指定课时的摘要草稿 | 教师 | `LessonSummaryRequest` / `AiDraftVO` | 已实现，仅返回草稿 |
| `GET` | `/api/v1/ai/admin/status` | 查询 AI 服务和模型配置状态 | 管理员/超级管理员 | 无 / `AiServiceStatusVO` | 已实现 |
| `POST` | `/api/v1/ai/submissions/{submissionId}/comment-draft` | 生成作业批改评语草稿 | 教师 | `AiDraftInstructionRequest` / `AiDraftVO` | 已实现，仅返回评语草稿 |
| `POST` | `/api/v1/ai/warnings/{warningId}/explanation` | 生成学习预警解释草稿 | 教师 | `AiDraftInstructionRequest` / `AiDraftVO` | 已实现，仅返回解释草稿 |
| `POST` | `/api/v1/ai/exams/paper-suggestions` | 根据授权题库生成组卷建议草稿 | 教师 | `PaperSuggestionRequest` / `AiDraftVO` | 已实现，仅从授权题库生成建议 |
...
| 方法 | 路径 | 接口说明 | 调用方 | 提供方 | 状态 |
| --- | --- | --- | --- | --- | --- |
| `POST` | `/_internal/v1/ai-context/course` | 向 AI 服务提供授权课程上下文 | `edu-ai-service` | `edu-biz-service` | 已实现，内部接口 |
| `POST` | `/_internal/v1/ai-context/submission` | 向 AI 服务提供授权作业提交上下文 | `edu-ai-service` | `edu-biz-service` | 已实现，教师提交上下文 |
| `POST` | `/_internal/v1/ai-context/warning` | 向 AI 服务提供授权学习预警上下文 | `edu-ai-service` | `edu-biz-service` | 已实现，教师预警上下文 |
| `POST` | `/_internal/v1/ai-context/paper` | 向 AI 服务提供授权题库上下文 | `edu-ai-service` | `edu-biz-service` | 已实现，教师题库上下文 |
